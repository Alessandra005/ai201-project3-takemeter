# -*- coding: utf-8 -*-
"""ai201_project3_takemeter_starter_clean_ale.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/18BQS_VLb3Jpdn1VDoUt4cGSi85BPFLKr
...
SYSTEM_PROMPT = """You are classifying posts from r/movies on Reddit.
...
Example: "Nolan structures Oppenheimer in two color modes — color for Oppenheimer's subjective sections, black and white for Strauss's hearing. The distinction is epistemological: color represents lived experience, black and white represents institutional record."
...
Example: "Interstellar's third act completely ruins what should have been a near-masterpiece. The bookshelf scene is embarrassing."

reaction: An immediate emotional response to a specific film, trailer, casting announcement, or industry event. Little to no argument — the post expresses a feeling in the moment, often anchored to a recent personal viewing.
Example: "Just got back from seeing Oppenheimer in IMAX and I am genuinely shaking. The Trinity test sequence is one of the most overwhelming things I've ever experienced in a theater."
